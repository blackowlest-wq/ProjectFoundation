...
| 資料 | 用途 |
| --- | --- |
| `../サンプル設計書/DB概念設計.md` | 概念モデル、業務上のエンティティ、設計方針 |
| `../サンプル設計書/機能一覧・受入条件.md` | DB整合性に関わる受入条件 |
| `../サンプル設計書/API一覧.md` | API入出力と永続化項目の対応 |
| `../サンプル設計書/状態遷移・業務フロー設計.md` | 承認状態と監査項目の更新規則 |
| `../サンプル設計書/入力チェック・業務ルール一覧.md` | DB制約だけでは表現しない業務ルール |
